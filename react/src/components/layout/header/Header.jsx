...
export const Header = withRouter((props) => {
  ...
  <div className="collapse navbar-collapse" id="navbarSupportedContent">
    <ul className="navbar-nav mr-auto">
      ...
      <li className="nav-item">
        <Link to="/notes" className="nav-link">All posts</Link>
      </li>
      <li className="nav-item">
        <Link to="/notes/my-notes" className="nav-link">My posts</Link>
      </li>
      <li className="nav-item">
        <Link to="/notes/create" className="nav-link">Add post</Link>
      </li>
      <li className="nav-item">
        <Link to="/form/Contact" className="nav-link">Contact</Link>
      </li>
    </ul>
